<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AnalisisRealizados.aspx.vb" Inherits="Analisis_AnalisisRealizados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <h1 class="h3 mb-1 text-gray-800">Análisis: Análisis Realizados</h1>
            ...
            <asp:GridView ID="Grilla" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Codigo" Visible="false">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_id_analisis" runat="server" Text='<%# Bind("ID") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Análisis">

                        <ItemTemplate>
                            <asp:Label ID="lb_nombre_analisis" runat="server" Text='<%# Bind("NOMBRE")%>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Fecha-Hora">
                        <ItemTemplate>
                            <asp:Label ID="lb_fecha_analisis" runat="server" Text='<%# Bind("FECHA")%>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Desplazamiento Seleccionado">
                        <ItemTemplate>
                            <asp:Label ID="lb_desplazamiento_analisis" runat="server" Text='<%# Bind("DESPLAZAMIENTO")%>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Opiniones Encontradas">
                        <ItemTemplate>
                            <asp:Label ID="lb_opiniones_analisis" runat="server" Text='<%# Bind("CANTIDAD_OPINIONES")%>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Detalle">
                        <ItemTemplate>
                            <asp:ImageButton ID="bt_detalle" runat="server" CausesValidation="False" ImageUrl="~/Imagenes/mostrar.png"
                                Width="25px" Height="25px" Text="Plan" ToolTip="Detalle"  CommandName="detalle"/>
                        </ItemTemplate>
                    </asp:TemplateField>
