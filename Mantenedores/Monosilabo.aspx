<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Monosilabo.aspx.vb" Inherits="Mantenedores_Monosilabo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h1 class="h3 mb-1 text-gray-800">Parámetros: Monosilabo</h1>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <th>
              Sentimiento: <asp:DropDownList ID="ddl_sentimiento" runat="server" CssClass="form-control">
                </asp:DropDownList>
            </th>
          
            <th><br />
                <asp:Button ID="btnConsulta" CssClass="btn btn-success" runat="server" Text="Consultar" />
            </th>
        </tr>
...
<%--                            <asp:ImageButton ID="bt_editar" runat="server" CausesValidation="False" CommandName="Edit"
                    ...
                    <asp:TemplateField HeaderText="Codigo">
                        <EditItemTemplate>
                            <asp:Label ID="tx_e_cod_monosilabo" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lb_cod_monosilabo" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Texto">
                        <EditItemTemplate>
                            <asp:Label ID="tx_e_texto" CssClass="small" runat="server" MaxLength="200" Text='<%# Bind("TEXTO")%>'
                                Width="100%"></asp:Label>
                            
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="tx_f_texto" CssClass="form-control small" runat="server" MaxLength="200" Text='<%# Bind("TEXTO")%>'
                                Width="100%" ValidationGroup="insert"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RFV_tx_f_texto" runat="server" ControlToValidate="tx_f_texto"
                    ...
                    <asp:TemplateField HeaderText="Intensidad">
                        <EditItemTemplate>
                            <asp:TextBox ID="tx_e_intensidad" CssClass="form-control small" runat="server" MaxLength="200" Text='<%# Bind("INTENSIDAD")%>'
                                Width="100%"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RFV_tx_e_intensidad" runat="server" ControlToValidate="tx_e_intensidad"
                                ValidationGroup="edita">
                                          <img src="../Imagenes/error16.png" alt="Requerido"/>
                            </asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="tx_f_intensidad" CssClass="form-control small" runat="server" MaxLength="200" Text='<%# Bind("INTENSIDAD") %>'
                                Width="100%" ValidationGroup="insert"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RFV_tx_f_intensidad" runat="server" ControlToValidate="tx_f_intensidad"
                                ValidationGroup="insert">
                                          <img src="../Imagenes/error16.png" alt="Requerido"/>
                            </asp:RequiredFieldValidator>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_intensidad" runat="server" Text='<%# Bind("INTENSIDAD") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                  ...
                  <asp:TemplateField HeaderText="Sentimiento">
                        <EditItemTemplate>
                            <asp:Label ID="tx_e_sentimiento" Visible="false" runat="server" Text='<%# Bind("CODIGO_SENTIMIENTO")%>' CssClass="small"></asp:Label>
                            <asp:Label ID="tx_e_sentimiento_v" runat="server" Text='<%# Bind("NOMBRE_SENTIMIENTO")%>' CssClass="small"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_sentimiento" Visible="false" runat="server" Text='<%# Bind("CODIGO_SENTIMIENTO")%>' CssClass="small"></asp:Label>
                            <asp:Label ID="lb_sentimiento_ev" runat="server" Text='<%# Bind("NOMBRE_SENTIMIENTO")%>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
