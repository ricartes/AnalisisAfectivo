<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Sentimiento.aspx.vb" Inherits="Mantenedores_Sentimiento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h1 class="h3 mb-1 text-gray-800">Parámetros: Sentimiento</h1>
            ...
            <asp:GridView ID="Grilla" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Codigo">
                        <EditItemTemplate>
                            <asp:Label ID="tx_e_cod_sentimiento" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lb_cod_sentimiento" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre">
                        <EditItemTemplate>
                            <asp:TextBox ID="tx_e_nombre" CssClass="form-control small" runat="server" MaxLength="200" Text='<%# Bind("NOMBRE") %>'
                                Width="100%"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RFV_tx_e_nombre" runat="server" ControlToValidate="tx_e_nombre"
                                ValidationGroup="edita">
                                          <img src="../Imagenes/error16.png" alt="Requerido"/>
                            </asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="tx_f_nombre" CssClass="form-control small" runat="server" MaxLength="200" Text='<%# Bind("NOMBRE") %>'
                                Width="100%" ValidationGroup="insert"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RFV_tx_f_nombre" runat="server" ControlToValidate="tx_f_nombre"
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_nombre" runat="server" Text='<%# Bind("NOMBRE") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
