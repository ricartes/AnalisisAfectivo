<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Palabra.aspx.vb" Inherits="Mantenedores_Palabra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h1 class="h3 mb-1 text-gray-800">Parámetros: Palabra</h1>
            ...
            <asp:GridView ID="Grilla" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Codigo">
                        <EditItemTemplate>
                            <asp:Label ID="tx_e_cod_palabra" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                        </FooterTemplate>
                        <ItemTemplate>
