<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Stopword.aspx.vb" Inherits="Mantenedores_Stopword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
      ...
      <h1 class="h3 mb-1 text-gray-800">Parámetros: Stopwords</h1>
            ...
            <asp:GridView ID="Grilla" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Codigo">
                        <EditItemTemplate>
                            <asp:Label ID="tx_e_cod_stopwowd" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lb_cod_stopword" runat="server" Text='<%# Bind("CODIGO") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre">
                        <EditItemTemplate>
                            <asp:TextBox ID="tx_e_texto" CssClass="form-control small" runat="server" MaxLength="200" Text='<%# Bind("TEXTO")%>'
                                Width="100%"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RFV_tx_e_texto" runat="server" ControlToValidate="tx_e_texto"
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_nombre" runat="server" Text='<%# Bind("TEXTO") %>' CssClass="small"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
