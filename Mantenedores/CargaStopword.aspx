<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CargaStopword.aspx.vb" Inherits="Mantenedores_CargaStopword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h1 class="h3 mb-1 text-gray-800">Cargas: Stopwords</h1>
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    </asp:ToolkitScriptManager>
        <table title="Carga planilla Stopwords"  class="table"  style="width:100%">

           <tr>
            <th colspan="5" >Carga planilla: Debe seleccionar un archivo xlsx. La HOJA del libro debe llamarse stopword. </th>
        </tr>
            <tr>
